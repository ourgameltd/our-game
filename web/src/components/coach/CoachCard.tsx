        ...
        <div className="flex items-center gap-2 flex-1 min-w-0 md:flex-row md:items-center md:gap-4">
          ...
          <div className="shrink-0 md:order-1">
            {coach.photo ? (
              ...
              <div className="w-9 h-9 md:w-10 md:h-10 bg-gradient-to-br from-secondary-400 to-secondary-600 dark:from-secondary-600 dark:to-secondary-800 rounded-full flex items-center justify-center text-white text-sm font-bold">
