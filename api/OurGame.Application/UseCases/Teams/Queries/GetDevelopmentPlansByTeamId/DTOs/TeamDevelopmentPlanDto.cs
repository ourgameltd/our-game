namespace OurGame.Application.UseCases.Teams.Queries.GetDevelopmentPlansByTeamId.DTOs;

/// <summary>
/// DTO for a development plan in the team development plans list
/// </summary>
public record TeamDevelopmentPlanDto
{
    ...
    public TeamDevelopmentPlanPeriodDto Period { get; init; } = new();

    /// <summary>The player associated with this plan (embedded to avoid extra calls)</summary>
    public TeamDevelopmentPlanPlayerDto Player { get; init; } = new();

    /// <summary>The goals within this development plan</summary>
    public List<TeamDevelopmentPlanGoalDto> Goals { get; init; } = new();
}

/// <summary>
/// DTO for the period covered by a development plan
/// </summary>
public record TeamDevelopmentPlanPeriodDto
{
...
/// <summary>
/// DTO for a player referenced in a team development plan
/// </summary>
public record TeamDevelopmentPlanPlayerDto
{
...
/// <summary>
/// DTO for a development goal within a team development plan
/// </summary>
public record TeamDevelopmentPlanGoalDto
{
