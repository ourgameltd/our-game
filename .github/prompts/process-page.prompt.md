# Add API calls for page static data replacement

For a given page on the web project you are to create a new API call or calls to replace any static data being used on the page and implement POST, DELETE, PUT operations as needed. 
...
- Should do any POST, PUT, DELETE operations and GET operations are required for this task.
