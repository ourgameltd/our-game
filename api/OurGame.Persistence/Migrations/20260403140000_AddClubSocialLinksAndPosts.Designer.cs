...
namespace OurGame.Persistence.Migrations
{
    ...
    [Migration("20260403140000_AddClubSocialLinksAndPosts")]
    partial class AddClubSocialLinksAndPosts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OurGame.Persistence.Models.ClubPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("ClubId")
                        .HasDatabaseName("IX_ClubPosts_ClubId");

                    b.HasIndex("IsPublic", "CreatedAt")
                        .HasDatabaseName("IX_ClubPosts_IsPublic_CreatedAt");

                    b.ToTable("ClubPosts", (string)null);
                });

            modelBuilder.Entity("OurGame.Persistence.Models.ClubSocialLinks", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("ClubId")
                        .IsUnique()
                        .HasDatabaseName("UX_ClubSocialLinks_ClubId");

                    b.ToTable("ClubSocialLinks", (string)null);
                });
            ...
            modelBuilder.Entity("OurGame.Persistence.Models.ClubPost", b =>
                {
                    b.HasOne("OurGame.Persistence.Models.Club", "Club")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_ClubPosts_Clubs");
            ...
            modelBuilder.Entity("OurGame.Persistence.Models.ClubSocialLinks", b =>
                {
                    b.HasOne("OurGame.Persistence.Models.Club", "Club")
                        .WithMany("ClubSocialLinks")
                        .HasForeignKey("ClubId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_ClubSocialLinks_Clubs");
