...
namespace OurGame.Application.UseCases.Clubs.Commands.UpdateClubPost.DTOs;

/// <summary>
/// Request DTO for updating an existing club post.
/// </summary>
public record UpdateClubPostRequestDto
{
    /// <summary>
    /// Post title (required).
    /// </summary>
