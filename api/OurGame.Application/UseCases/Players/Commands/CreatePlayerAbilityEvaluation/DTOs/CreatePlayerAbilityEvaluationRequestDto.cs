...
namespace OurGame.Application.UseCases.Players.Commands.CreatePlayerAbilityEvaluation.DTOs;

/// <summary>
/// Request DTO for creating a new player ability evaluation.
/// Contains attribute ratings and optional coach notes for a specific evaluation period.
/// </summary>
public record CreatePlayerAbilityEvaluationRequestDto
{
    /// <summary>
