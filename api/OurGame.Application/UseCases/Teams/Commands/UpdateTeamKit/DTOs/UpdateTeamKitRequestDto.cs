...
namespace OurGame.Application.UseCases.Teams.Commands.UpdateTeamKit.DTOs;

/// <summary>
/// Request DTO for updating an existing team kit.
/// </summary>
public record UpdateTeamKitRequestDto
{
    /// <summary>
