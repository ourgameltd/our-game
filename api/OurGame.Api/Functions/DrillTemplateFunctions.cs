...
public class DrillTemplateFunctions
{
    ...
    [OpenApiParameter(name: "category", In = ParameterLocation.Query, Required = false, Type = typeof(string), Description = "Filter by drill template category (Drill, Skills Practice, Game Related Practice, Conditioned Game, Mixed)")]
