        ...
        <div className="flex flex-col md:flex-row md:items-center md:gap-4 flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mb-3 md:mb-0 md:shrink-0 md:order-1">
            {coach.photo ? (
              ...
              <div className="w-12 h-12 md:w-10 md:h-10 bg-gradient-to-br from-secondary-400 to-secondary-600 dark:from-secondary-600 dark:to-secondary-800 rounded-full flex items-center justify-center text-white text-lg md:text-base font-bold shrink-0">
          ...
          {/* Status/Actions */}
          <div className="mt-auto pt-3 md:pt-0 md:mt-0 flex items-center justify-between md:justify-end md:gap-4 md:shrink-0 md:order-7">
