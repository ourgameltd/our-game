...
- Training session create/update/query flows now use template references (`TemplateId`/`AppliedTemplates`) instead of a dedicated training-session category field.
